...
if "%CONDA_BAT%"=="" (
  ...
  echo Please edit start_app.bat and set CONDA_BAT to your conda path.
  pause
  exit /b 1
)
...
start "ECG Streamlit App" cmd /k "call %CONDA_BAT_SHORT% activate ecg_project && streamlit run app.py"
